...
//	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h4>Aperçu avant impression</h4><p>S'il vous plaît utiliser la fonction " +
				"d'impression de votre navigateur pour imprimer ce tableau. Appuyez sur Echap lorsque vous" +
				" avez terminé ou pour quitter ce mode.</p>",
		"sMessage": null,
		"bShowAll": true,
