							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Numéro</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">Référence</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
										<f:select path="type">
											<f:option value="entree">entrée</f:option>
											<f:option value="sortie">sortie</f:option>
											<f:option value="depreciation">dépréciation</f:option>
