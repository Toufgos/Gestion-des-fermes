                            ...
                            <div class="x_panel">
                                <div class="x_title">
									<h2 id="profile-tab-ctx">
										Voici la liste des Mouvement <small> ! </small>
									</h2>
								...
								<div class="x_content">
									...
									<div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Mouvement des entrées </a>
                                            </li>
                                            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab"  aria-expanded="false">Mouvement des sorties</a>
                                            </li>
                                            <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">dépréciation du Stock</a>
                                            </li> 
                                        </ul>
										...
										<tbody>
											...
											<c:forEach items="${res }" var="li">
												<tr>
													...
													<td class=" ">${li.numMouvement }</td>
														
													<td class=" ">${li.reference}</td>
													...
													<td class=" last">
														...
														<form action="AjoutLigneMouvementProduit">
														<input name="ferme" id="id_Ferme" value="${li.id }"
														type="hidden" />
														<button type="submit" value="${li.id }"
